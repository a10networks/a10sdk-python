...
class Lw4O6(A10BaseClass):
    ...
    :param health_check_gateway_list: {"minItems": 1, "items": {"type": "health-check-gateway"}, "uniqueItems": true, "array": [{"required": ["ipv4-addr", "ipv6-addr"], "properties": {"ipv4-addr": {"optional": false, "type": "string", "description": "LW-4over6 IPv4 Gateway", "format": "ipv4-address"}, "ipv6-addr": {"optional": false, "type": "string", "description": "LW-4over6 IPv6 Gateway", "format": "ipv6-address"}}}], "type": "array", "$ref": "/axapi/v3/cgnv6/lw-4o6/health-check-gateway/{ipv4-addr}+{ipv6-addr}"}
