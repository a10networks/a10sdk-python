...
class Stats(A10BaseClass):
    ...
    :param lid_pass_through: {"description": "LSN LID Pass-through", "format": "counter", "type": "number", "oid": "46", "optional": true, "size": "8"}
    ...
    :param source_matches_prefix: {"description": "Source Address Prefix Match Drop", "format": "counter", "type": "number", "oid": "44", "optional": true, "size": "8"}
    ...
    :param lid_drop: {"description": "LSN LID Drop", "format": "counter", "type": "number", "oid": "45", "optional": true, "size": "8"}
    ...
    :param l3: {"description": "Layer 3 Forwarded Packets", "format": "counter", "type": "number", "oid": "43", "optional": true, "size": "8"}
    ...
    :param no_class_list_match: {"description": "No Class-List Match", "format": "counter", "type": "number", "oid": "47", "optional": true, "size": "8"}
...
class Global(A10BaseClass):
    ...
    URL for this object::
    `https://<Hostname|Ip address>//axapi/v3/cgnv6/nat64/global/stats`.
    ...
    def __init__(self, **kwargs):
        ...
        self.required=[]
        self.b_key = "global"
        self.a10_url="/axapi/v3/cgnv6/nat64/global/stats"
        self.DeviceProxy = ""
        self.stats = {}
