...
class Member(A10BaseClass):
    ...
    URL for this object::
    `https://<Hostname|Ip address>//axapi/v3/ip/nat/pool-group/{pool_group_name}/member/{pool_name}`.
    ...
    def __init__(self, **kwargs):
        ...
        self.b_key = "member"
        self.a10_url="/axapi/v3/ip/nat/pool-group/{pool_group_name}/member/{pool_name}"
        self.DeviceProxy = ""
        self.uuid = ""
        self.pool_name = ""
