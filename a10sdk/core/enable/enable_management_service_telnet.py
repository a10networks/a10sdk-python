...
class Telnet(A10BaseClass):
    ...
    URL for this object::
    `https://<Hostname|Ip address>//axapi/v3/enable-management/service/telnet`.
    ...
    def __init__(self, **kwargs):
        ...
        self.required=[]
        self.b_key = "telnet"
        self.a10_url="/axapi/v3/enable-management/service/telnet"
        self.DeviceProxy = ""
        self.acl_v4_list = []
        self.acl_v6_list = []
        self.management = ""
