...
class LicenseManager(A10BaseClass):
    ...
    :param reminder_list: {"minItems": 1, "items": {"type": "reminder"}, "uniqueItems": true, "array": [{"required": ["reminder-value"], "properties": {"reminder-value": {"description": "Configure reminder for grace time (Hour)", "format": "number", "type": "number", "maximum": 1000000, "minimum": 1, "optional": false}, "uuid": {"description": "uuid of the object", "format": "string", "minLength": 1, "modify-not-allowed": 1, "optional": true, "maxLength": 64, "type": "string"}}}], "type": "array", "$ref": "/axapi/v3/license-manager/reminder/{reminder-value}"}
