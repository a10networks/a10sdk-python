...
class TacacsHostname(A10BaseClass):
    
    """Class Description::
    Specify the hostname of TACACS+ server.

    Class tacacs-hostname supports CRUD Operations and inherits from `common/A10BaseClass`.
    ...
    URL for this object::
    `https://<Hostname|Ip address>//axapi/v3/tacacs-server/host/tacacs-hostname/{hostname}`.
    ...
    def __init__(self, **kwargs):
        ...
        self.b_key = "tacacs-hostname"
        self.a10_url="/axapi/v3/tacacs-server/host/tacacs-hostname/{hostname}"
        self.DeviceProxy = ""
        self.secret = {}
        self.hostname = ""
