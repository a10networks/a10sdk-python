...
class GenericProxy(A10BaseClass):
    
    """Class Description::
    Statistics for the object generic-proxy.

    Class generic-proxy supports CRUD Operations and inherits from `common/A10BaseClass`.
    ...
    URL for this object::
    `https://<Hostname|Ip address>//axapi/v3/slb/generic-proxy/stats`.
    ...
    def __init__(self, **kwargs):
        self.ERROR_MSG = ""
        self.required=[]
        self.b_key = "generic-proxy"
        self.a10_url="/axapi/v3/slb/generic-proxy/stats"
        self.DeviceProxy = ""
        self.stats = {}
