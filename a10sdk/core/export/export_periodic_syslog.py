...
class Syslog(A10BaseClass):
    ...
    :param syslog: {"description": "Syslog file", "format": "string", "minLength": 1, "optional": false, "maxLength": 63, "type": "string"}
    ...
    URL for this object::
    `https://<Hostname|Ip address>//axapi/v3/export-periodic/syslog/{syslog}`.
    ...
    def __init__(self, **kwargs):
        self.ERROR_MSG = ""
        self.required = [ "syslog"]

        self.b_key = "syslog"
        self.a10_url="/axapi/v3/export-periodic/syslog/{syslog}"
        self.DeviceProxy = ""
        self.syslog = ""
        self.uuid = ""
        self.remote_file = ""
