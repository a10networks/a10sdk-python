...
class Rules(A10BaseClass):
    ...
    :param icmpv6_code: {"description": "ICMPv6 code number", "format": "number", "not-list": ["v6-any-code", "special-v6-code"], "maximum": 254, "minimum": 0, "type": "number"}
    ...
    :param v6_any_code: {"default": 0, "not-list": ["icmpv6-code", "special-v6-code"], "type": "number", "description": "Any ICMPv6 code", "format": "flag"}
    ...
    :param special_v6_code: {"not-list": ["v6-any-code", "icmpv6-code"], "enum": ["addr-unreachable", "admin-prohibited", "no-route", "not-neighbour", "port-unreachable"], "type": "string", "description": "'addr-unreachable': Code 3, address unreachable; 'admin-prohibited': Code 1, admin prohibited; 'no-route': Code 0, no route to destination; 'not-neighbour': Code 2, not neighbor; 'port-unreachable': Code 4, destination port unreachable; ", "format": "enum"}
