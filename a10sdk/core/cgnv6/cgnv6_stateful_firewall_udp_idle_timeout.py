...
class IdleTimeout(A10BaseClass):
    ...
    :param idle_timeout_val_port_range: {"description": "Idle timeout for IPv4 and IPv6 TCP established sessions (Idle timeout for IPv4 and IPv6 TCP established sessions (default: 300 seconds))", "format": "number", "default": 300, "optional": true, "maximum": 15000, "minimum": 60, "not": "fast", "type": "number"}
