...
class DnsMxRecord(A10BaseClass):
    ...
    URL for this object::
    `https://<Hostname|Ip address>//axapi/v3/gslb/zone/{name}/service/{service_port}+{service_name}/dns-mx-record/{mx_name}/oper`.
    ...
    def __init__(self, **kwargs):
        ...
        self.a10_url="/axapi/v3/gslb/zone/{name}/service/{service_port}+{service_name}/dns-mx-record/{mx_name}/oper"
        self.DeviceProxy = ""
        self.oper = {}
        self.mx_name = ""
