...
class Ssh(A10BaseClass):
    ...
    URL for this object::
    `https://<Hostname|Ip address>//axapi/v3/enable-management/service/ssh`.
    ...
    def __init__(self, **kwargs):
        ...
        self.required=[]
        self.b_key = "ssh"
        self.a10_url="/axapi/v3/enable-management/service/ssh"
        self.DeviceProxy = ""
        self.acl_v6_list = []
        self.acl_v4_list = []
        self.ve_cfg = []
