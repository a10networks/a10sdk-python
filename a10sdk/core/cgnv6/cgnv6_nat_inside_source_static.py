...
class Static(A10BaseClass):
    ...
    URL for this object::
    `https://<Hostname|Ip address>//axapi/v3/cgnv6/nat/inside/source/static/{src_address}+{nat_address}`.
    ...
    def __init__(self, **kwargs):
        ...
        self.b_key = "static"
        self.a10_url="/axapi/v3/cgnv6/nat/inside/source/static/{src_address}+{nat_address}"
        self.DeviceProxy = ""
        self.nat_address = ""
        self.vrid = ""
        self.src_address = ""
