...
class Udp(A10BaseClass):
    ...
    URL for this object::
    `https://<Hostname|Ip address>//axapi/v3/cgnv6/stateful-firewall/endpoint-independent-filtering/udp`.
    ...
    def __init__(self, **kwargs):
        ...
        self.required=[]
        self.b_key = "udp"
        self.a10_url="/axapi/v3/cgnv6/stateful-firewall/endpoint-independent-filtering/udp"
        self.DeviceProxy = ""
        self.port_list = []
        self.uuid = ""
