...
class OspfIp(A10BaseClass):
    ...
    URL for this object::
    `https://<Hostname|Ip address>//axapi/v3/interface/ethernet/{ifnum}/ip/ospf/ospf-ip/{ip_addr}`.
    ...
    def __init__(self, **kwargs):
        ...
        self.b_key = "ospf-ip"
        self.a10_url="/axapi/v3/interface/ethernet/{ifnum}/ip/ospf/ospf-ip/{ip_addr}"
        self.DeviceProxy = ""
        self.dead_interval = ""
