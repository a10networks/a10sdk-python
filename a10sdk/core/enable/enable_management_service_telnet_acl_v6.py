...
class AclV6(A10BaseClass):
    ...
    URL for this object::
    `https://<Hostname|Ip address>//axapi/v3/enable-management/service/telnet/acl-v6/{acl_name}`.
    ...
    def __init__(self, **kwargs):
        ...
        self.b_key = "acl-v6"
        self.a10_url="/axapi/v3/enable-management/service/telnet/acl-v6/{acl_name}"
        self.DeviceProxy = ""
        self.acl_name = ""
        self.ve_cfg = []
        self.eth_cfg = []
