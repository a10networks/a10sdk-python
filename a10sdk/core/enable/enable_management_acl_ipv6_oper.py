...
class AclIpv6(A10BaseClass):
    
    """Class Description::
    Operational Status for the object acl-ipv6.

    Class acl-ipv6 supports CRUD Operations and inherits from `common/A10BaseClass`.
    ...
    URL for this object::
    `https://<Hostname|Ip address>//axapi/v3/enable-management/acl-ipv6/oper`.
    ...
    def __init__(self, **kwargs):
        ...
        self.required=[]
        self.b_key = "acl-ipv6"
        self.a10_url="/axapi/v3/enable-management/acl-ipv6/oper"
        self.DeviceProxy = ""
        self.oper = {}
