...
class Aflex(A10BaseClass):
    ...
    :param dst_file: {"description": "destination file name for copy and rename action", "format": "string-rlx", "minLength": 1, "optional": true, "maxLength": 63, "type": "string"}
    ...
    :param file: {"description": "aflex local file name", "format": "string-rlx", "minLength": 1, "optional": true, "maxLength": 63, "type": "string"}
    :param size: {"description": "aflex file size in byte", "format": "number", "type": "number", "maximum": 2147483647, "minimum": 0, "optional": true}
...
Class Description::
    ...
    URL for this object::
    `https://<Hostname|Ip address>//axapi/v3/file/aflex`.
    ...
    def __init__(self, **kwargs):
        ...
        self.required=[]
        self.b_key = "aflex"
        self.a10_url="/axapi/v3/file/aflex"
        self.DeviceProxy = ""
        self.action = ""
        self.dst_file = ""
        self.file_handle = ""
