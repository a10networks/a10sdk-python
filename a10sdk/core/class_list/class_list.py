...
class StrList(A10BaseClass):
    ...
    :param str: {"minLength": 1, "maxLength": 255, "type": "string", "description": "Specify key string", "format": "string-rlx"}
    :param value_str: {"minLength": 1, "maxLength": 639, "type": "string", "description": "Specify value string", "format": "string-rlx"}
...
class ClassList(A10BaseClass):
    ...
    :param ipv4_list: {"minItems": 1, "items": {"type": "object"}, "uniqueItems": true, "type": "array", "array": [{"properties": {"lid": {"description": "Use Limit ID defined in template (Specify LID index)", "format": "number", "maximum": 31, "minimum": 1, "not": "glid", "type": "number"}, "glid": {"description": "Use global Limit ID (Specify global LID index)", "format": "number", "maximum": 1023, "minimum": 1, "not": "lid", "type": "number"}, "ipv4addr": {"type": "string", "description": "Specify IP address", "format": "ipv4-cidr"}, "lsn-lid": {"description": "LSN Limit ID (LID index)", "minimum": 1, "type": "number", "maximum": 1023, "format": "number"}, "lsn-radius-profile": {"description": "LSN RADIUS Profile Index", "minimum": 1, "type": "number", "maximum": 16, "format": "number"}, "optional": true}}]}
    :param str_list: {"minItems": 1, "items": {"type": "object"}, "uniqueItems": true, "type": "array", "array": [{"properties": {"str": {"minLength": 1, "maxLength": 255, "type": "string", "description": "Specify key string", "format": "string-rlx"}, "value-str": {"minLength": 1, "maxLength": 639, "type": "string", "description": "Specify value string", "format": "string-rlx"}, "str-glid-dummy": {"default": 0, "not": "str-lid-dummy", "type": "number", "description": "Use global Limit ID", "format": "flag"}, "str-glid": {"description": "Global LID index", "minimum": 1, "type": "number", "maximum": 1023, "format": "number"}, "str-lid-dummy": {"default": 0, "not": "str-glid-dummy", "type": "number", "description": "Use Limit ID defined in template", "format": "flag"}, "str-lid": {"description": "LID index", "minimum": 1, "type": "number", "maximum": 31, "format": "number"}, "optional": true}}]}
    ...
    :param ipv6_list: {"minItems": 1, "items": {"type": "object"}, "uniqueItems": true, "type": "array", "array": [{"properties": {"v6-lsn-lid": {"description": "LSN Limit ID (LID index)", "minimum": 1, "type": "number", "maximum": 1023, "format": "number"}, "v6-glid": {"description": "Use global Limit ID (Specify global LID index)", "format": "number", "maximum": 1023, "minimum": 1, "not": "v6-lid", "type": "number"}, "ipv6-addr": {"type": "string", "description": "Specify IPv6 host or subnet", "format": "ipv6-address-plen"}, "v6-lid": {"description": "Use Limit ID defined in template (Specify LID index)", "format": "number", "maximum": 31, "minimum": 1, "not": "v6-glid", "type": "number"}, "optional": true, "v6-lsn-radius-profile": {"description": "LSN RADIUS Profile Index", "minimum": 1, "type": "number", "maximum": 16, "format": "number"}}}]}
    ...
    :param type: {"description": "'ac': Make class-list type Aho-Corasick; 'dns': Make class-list type DNS; 'ipv4': Make class-list type IPv4; 'ipv6': Make class-list type IPv6; 'string': Make class-list type String; 'string-case-insensitive': Make class-list type String-case-insensitive; ", "format": "enum", "type": "string", "enum": ["ac", "dns", "ipv4", "ipv6", "string", "string-case-insensitive"], "modify-not-allowed": 1, "optional": true}
