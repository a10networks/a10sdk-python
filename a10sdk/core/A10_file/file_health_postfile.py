...
class HealthPostfile(A10BaseClass):
    ...
    :param file: {"description": "Specify the File Name", "format": "string", "minLength": 1, "optional": true, "maxLength": 63, "type": "string"}
...
Class Description::
    ...
    URL for this object::
    `https://<Hostname|Ip address>//axapi/v3/file/health-postfile`.
    ...
    def __init__(self, **kwargs):
        ...
        self.a10_url="/axapi/v3/file/health-postfile"
        self.DeviceProxy = ""
        self.action = ""
        self.dst_file = ""
        self.file_handle = ""
