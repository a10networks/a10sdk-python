...
class Sip(A10BaseClass):
    ...
    :param smp_call_id_rtp_session: {"default": 0, "optional": true, "type": "number", "description": "Create the across cpu call-id rtp session", "format": "flag"}
    ...
    :param name: {"description": "SIP Template Name", "format": "string-rlx", "minLength": 1, "optional": false, "maxLength": 63, "type": "string"}
