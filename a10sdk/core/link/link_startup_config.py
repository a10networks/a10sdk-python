...
class StartupConfig(A10BaseClass):
    ...
    :param secondary: {"description": "Create link in secondary partition", "partition-visibility": "shared", "default": 0, "type": "number", "format": "flag", "optional": true}
    :param primary: {"description": "Create link in primary partition", "partition-visibility": "shared", "default": 0, "type": "number", "format": "flag", "optional": true}
