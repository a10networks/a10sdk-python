...
class Policy(A10BaseClass):
    ...
    def __init__(self, **kwargs):
        ...
        self.b_key = "policy"
        self.a10_url="/axapi/v3/aam/authorization/policy/{name}"
        self.DeviceProxy = ""
        self.uuid = ""
        self.server = ""
        self.service_group = ""
