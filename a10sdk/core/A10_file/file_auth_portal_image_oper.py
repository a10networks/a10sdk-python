...
class AuthPortalImage(A10BaseClass):
    ...
    """Class Description::
    Operational Status for the object auth-portal-image.
    ...
    URL for this object::
    `https://<Hostname|Ip address>//axapi/v3/file/auth-portal-image/oper`.
    ...
    def __init__(self, **kwargs):
        ...
        self.a10_url="/axapi/v3/file/auth-portal-image/oper"
        self.DeviceProxy = ""
        self.oper = {}
