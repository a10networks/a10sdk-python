...
class License(A10BaseClass):
    ...
    :param file: {"description": "license local file name", "format": "string", "minLength": 1, "optional": true, "maxLength": 63, "type": "string"}
    :param size: {"optional": true, "type": "number", "description": "license file size in byte", "format": "number"}
...
Class Description::
    ...
    URL for this object::
    `https://<Hostname|Ip address>//axapi/v3/file/license`.
    ...
    def __init__(self, **kwargs):
        ...
        self.required=[]
        self.b_key = "license"
        self.a10_url="/axapi/v3/file/license"
        self.DeviceProxy = ""
        self.action = ""
        self.dst_file = ""
        self.file_handle = ""
