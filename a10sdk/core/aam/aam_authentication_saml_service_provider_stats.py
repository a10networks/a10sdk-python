...
class Stats(A10BaseClass):
    ...
    :param SLO_error: {"description": "Single Logout Error", "format": "counter", "type": "number", "oid": "11", "optional": true, "size": "8"}
    ...
    :param ACS_authz_fail: {"description": "SAML Single-Sign-On Authorization Fail", "format": "counter", "type": "number", "oid": "7", "optional": true, "size": "8"}
    :param SLO_req: {"description": "Single Logout Request", "format": "counter", "type": "number", "oid": "9", "optional": true, "size": "8"}
    :param Login_auth_resp: {"description": "Login Authentication Response", "format": "counter", "type": "number", "oid": "4", "optional": true, "size": "8"}
    :param SLO_success: {"description": "Single Logout Success", "format": "counter", "type": "number", "oid": "10", "optional": true, "size": "8"}
    :param ACS_success: {"description": "SAML Single-Sign-On Success", "format": "counter", "type": "number", "oid": "6", "optional": true, "size": "8"}
    :param ACS_error: {"description": "SAML Single-Sign-On Error", "format": "counter", "type": "number", "oid": "8", "optional": true, "size": "8"}
    :param Other_error: {"description": "Other Error", "format": "counter", "type": "number", "oid": "12", "optional": true, "size": "8"}
    :param ACS_req: {"description": "SAML Single-Sign-On Request", "format": "counter", "type": "number", "oid": "5", "optional": true, "size": "8"}
