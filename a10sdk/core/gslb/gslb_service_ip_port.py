...
class SamplingEnable(A10BaseClass):
    ...
    :param counters1: {"enum": ["all", "active", "current"], "type": "string", "description": "'all': all; 'active': Active Servers; 'current': Current Connections; ", "format": "enum"}
...
class Port(A10BaseClass):
    ...
    :param sampling_enable: {"minItems": 1, "items": {"type": "object"}, "uniqueItems": true, "type": "array", "array": [{"properties": {"optional": true, "counters1": {"enum": ["all", "active", "current"], "type": "string", "description": "'all': all; 'active': Active Servers; 'current': Current Connections; ", "format": "enum"}}}]}
