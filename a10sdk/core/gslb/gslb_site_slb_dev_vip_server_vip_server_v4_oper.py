...
class VipServerV4(A10BaseClass):
    ...
    """Class Description::
    Operational Status for the object vip-server-v4.
    ...
    URL for this object::
    `https://<Hostname|Ip address>//axapi/v3/gslb/site/{site_name}/slb-dev/{device_name}/vip-server/vip-server-v4/{ipv4}/oper`.
    ...
    def __init__(self, **kwargs):
        ...
        self.a10_url="/axapi/v3/gslb/site/{site_name}/slb-dev/{device_name}/vip-server/vip-server-v4/{ipv4}/oper"
        self.DeviceProxy = ""
        self.oper = {}
        self.ipv4 = ""
