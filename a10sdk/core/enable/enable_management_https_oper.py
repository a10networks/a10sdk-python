...
class Https(A10BaseClass):
    ...
    """Class Description::
    Operational Status for the object https.
    ...
    URL for this object::
    `https://<Hostname|Ip address>//axapi/v3/enable-management/https/oper`.
    ...
    def __init__(self, **kwargs):
        ...
        self.required=[]
        self.b_key = "https"
        self.a10_url="/axapi/v3/enable-management/https/oper"
        self.DeviceProxy = ""
        self.oper = {}
