...
class PoolGroup(A10BaseClass):
    ...
    :param member_list: {"minItems": 1, "items": {"type": "member"}, "uniqueItems": true, "array": [{"required": ["pool-name"], "properties": {"pool-name": {"description": "Specify NAT pool name", "format": "string-rlx", "minLength": 1, "optional": false, "maxLength": 63, "type": "string"}}}], "type": "array", "$ref": "/axapi/v3/ip/nat/pool-group/{pool-group-name}/member/{pool-name}"}
    ...
    URL for this object::
    `https://<Hostname|Ip address>//axapi/v3/ip/nat/pool-group/{pool_group_name}`.
    ...
    def __init__(self, **kwargs):
        ...
        self.a10_url="/axapi/v3/ip/nat/pool-group/{pool_group_name}"
        self.DeviceProxy = ""
        self.member_list = []
