...
class Port(A10BaseClass):
    ...
    :param resel_on_reset: {"default": 0, "optional": true, "type": "number", "description": "When receiving reset from server, do the server/port reselection (default is 0, don't do reselection)", "format": "flag"}
    ...
    :param decrement: {"description": "Decrease after every round of DNS query (default is 0)", "format": "number", "default": 0, "optional": true, "maximum": 7, "minimum": 0, "type": "number"}
    ...
    :param weight: {"description": "Weight (port weight)", "format": "number", "default": 1, "optional": true, "maximum": 100, "minimum": 1, "type": "number"}
    ...
    :param name: {"description": "Port template name", "format": "string-rlx", "default": "default", "minLength": 1, "optional": false, "maxLength": 63, "type": "string"}
    ...
    :param down_timer: {"description": "The timer to bring the marked down server/port to up (default is 0, never bring up) (The timer to bring up server (in second, default is 0))", "format": "number", "default": 0, "optional": true, "maximum": 255, "minimum": 0, "type": "number"}
