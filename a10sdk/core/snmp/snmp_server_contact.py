...
class Contact(A10BaseClass):
    ...
    :param contact_name: {"description": "Identification of the contact person for this managed node", "format": "string-rlx", "minLength": 1, "optional": true, "maxLength": 255, "type": "string"}
