...
class IcmpRateLimit(A10BaseClass):
    ...
    :param icmp_lockup: {"description": "Enter lockup state when ICMP rate exceeds lockup rate limit. help-val Maximum rate limit. If exceeds this limit, drop all ICMP packet for a time period", "format": "number", "type": "number", "maximum": 65535, "minimum": 1, "optional": true}
    ...
    URL for this object::
    `https://<Hostname|Ip address>//axapi/v3/icmp-rate-limit`.
    ...
    def __init__(self, **kwargs):
        ...
        self.a10_url="/axapi/v3/icmp-rate-limit"
        self.DeviceProxy = ""
