...
class Ospf(A10BaseClass):
    ...
    :param router_id: {"optional": true, "type": "string", "description": "router-id for the OSPF process (OSPFv3 router-id in IPv4 address format)", "format": "ipv4-address"}
    ...
    :param log_adjacency_changes: {"optional": true, "enum": ["detail", "disable"], "type": "string", "description": "'detail': Log changes in adjacency state; 'disable': Disable logging; ", "format": "enum"}
