...
class RedistList(A10BaseClass):
    ...
    :param type: {"enum": ["bgp", "connected", "floating-ip", "ip-nat-list", "ip-nat", "isis", "lw4o6", "ospf", "static"], "type": "string", "description": "'bgp': Border Gateway Protocol (BGP); 'connected': Connected; 'floating-ip': Floating IP; 'ip-nat-list': IP NAT list; 'ip-nat': IP NAT; 'isis': ISO IS-IS; 'lw4o6': LW4O6 Prefix; 'ospf': Open Shortest Path First (OSPF); 'static': Static routes; ", "format": "enum"}
    :param DeviceProxy: The device proxy for REST operations and session handling. Refer to `common/device_proxy.py`
...
class Redistribute(A10BaseClass):
    ...
    URL for this object::
    `https://<Hostname|Ip address>//axapi/v3/router/rip/redistribute`.
    ...
    def __init__(self, **kwargs):
        ...
        self.a10_url="/axapi/v3/router/rip/redistribute"
        self.DeviceProxy = ""
        self.vip_list = []
        self.redist_list = []
        self.uuid = ""
