...
class ClassList(A10BaseClass):
    ...
    URL for this object::
    `https://<Hostname|Ip address>//axapi/v3/slb/template/dns/{name}/class-list`.
    ...
    def __init__(self, **kwargs):
        ...
        self.a10_url="/axapi/v3/slb/template/dns/{name}/class-list"
        self.DeviceProxy = ""
        self.lid_list = []
        self.name = ""
        self.uuid = ""
