...
class Interface(A10BaseClass):
    ...
    :param ethernet: {"not-list": ["ve", "management"], "type": "number", "description": "configure lldp management-address interface ethernet (lldp management-address interface port number)", "format": "interface"}
    ...
    :param ve: {"description": "configure lldp management-address interface management (lldp management-address interface port number)", "format": "number", "not-list": ["ethernet", "management"], "maximum": 4094, "minimum": 2, "type": "number"}
...
class Dns(A10BaseClass):
    ...
    URL for this object::
    `https://<Hostname|Ip address>//axapi/v3/network/lldp/management-address/dns/{dns}`.
