...
class IpLists(A10BaseClass):
    ...
    :param listname: {"type": "string", "format": "string"}
    ...
    :param ipaddr: {"type": "string", "format": "string"}
    ...
    :param ipmask: {"type": "string", "format": "string"}
...
class Oper(A10BaseClass):
    ...
    :param ip_lists: {"minItems": 1, "items": {"type": "object"}, "uniqueItems": true, "type": "array", "array": [{"properties": {"listname": {"type": "string", "format": "string"}, "hits": {"type": "number", "format": "number"}, "errors": {"type": "number", "format": "number"}, "last": {"type": "string", "format": "string"}, "total-entries-in-list": {"type": "number", "format": "number"}, "optional": true, "ipaddr": {"type": "string", "format": "string"}, "filename": {"type": "string", "format": "string"}, "file-lines": {"type": "number", "format": "number"}, "ipaddr-filter": {"type": "number", "format": "number"}, "ipmask": {"type": "string", "format": "string"}, "type": {"enum": ["manual", "file"], "type": "string", "format": "enum"}, "group-id": {"type": "number", "format": "number"}}}]}
    :param DeviceProxy: The device proxy for REST operations and session handling. Refer to `common/device_proxy.py`
