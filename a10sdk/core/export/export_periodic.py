...
class ExportPeriodic(A10BaseClass):
    ...
    :param axdebug_list: {"minItems": 1, "items": {"type": "axdebug"}, "uniqueItems": true, "array": [{"required": ["axdebug"], "properties": {"uuid": {"description": "uuid of the object", "format": "string", "minLength": 1, "modify-not-allowed": 1, "optional": true, "maxLength": 64, "type": "string"}, "remote-file": {"optional": true, "type": "string", "description": "profile name for remote url", "format": "url"}, "merged-pcap": {"default": 0, "optional": true, "type": "number", "description": "Export the merged pcap file when there are multiple Export sessions", "format": "flag"}, "period": {"description": "Specify the period in second", "format": "number", "type": "number", "maximum": 31536000, "minimum": 60, "optional": true}, "axdebug": {"description": "AX Debug Packet File", "format": "string", "minLength": 1, "optional": false, "maxLength": 63, "type": "string"}, "use-mgmt-port": {"default": 0, "optional": true, "type": "number", "description": "Use management port as source port", "format": "flag"}}}], "type": "array", "$ref": "/axapi/v3/export-periodic/axdebug/{axdebug}"}
    :param thales_secworld_list: {"minItems": 1, "items": {"type": "thales-secworld"}, "uniqueItems": true, "array": [{"required": ["thales-secworld"], "properties": {"uuid": {"description": "uuid of the object", "format": "string", "minLength": 1, "modify-not-allowed": 1, "optional": true, "maxLength": 64, "type": "string"}, "remote-file": {"optional": true, "type": "string", "description": "profile name for remote url", "format": "url"}, "period": {"description": "Specify the period in second", "format": "number", "type": "number", "maximum": 31536000, "minimum": 60, "optional": true}, "thales-secworld": {"description": "export Thales security world files - in .tgz format that has all files needed by AX", "format": "string", "minLength": 1, "optional": false, "maxLength": 63, "type": "string"}, "use-mgmt-port": {"default": 0, "optional": true, "type": "number", "description": "Use management port as source port", "format": "flag"}, "overwrite": {"default": 0, "optional": true, "type": "number", "description": "Overwrite existing file", "format": "flag"}}}], "type": "array", "$ref": "/axapi/v3/export-periodic/thales-secworld/{thales-secworld}"}
    :param ssl_crl_list: {"minItems": 1, "items": {"type": "ssl-crl"}, "uniqueItems": true, "array": [{"required": ["ssl-crl"], "properties": {"uuid": {"description": "uuid of the object", "format": "string", "minLength": 1, "modify-not-allowed": 1, "optional": true, "maxLength": 64, "type": "string"}, "period": {"description": "Specify the period in second", "format": "number", "type": "number", "maximum": 31536000, "minimum": 60, "optional": true}, "remote-file": {"optional": true, "type": "string", "description": "profile name for remote url", "format": "url"}, "use-mgmt-port": {"default": 0, "optional": true, "type": "number", "description": "Use management port as source port", "format": "flag"}, "ssl-crl": {"description": "SSL Crl File", "format": "string", "minLength": 1, "optional": false, "maxLength": 255, "type": "string"}}}], "type": "array", "$ref": "/axapi/v3/export-periodic/ssl-crl/{ssl-crl}"}
    :param ssl_cert_key_list: {"minItems": 1, "items": {"type": "ssl-cert-key"}, "uniqueItems": true, "array": [{"required": ["ssl-cert-key"], "properties": {"uuid": {"description": "uuid of the object", "format": "string", "minLength": 1, "modify-not-allowed": 1, "optional": true, "maxLength": 64, "type": "string"}, "ssl-cert-key": {"description": "Local SSL Key/Certificate file name", "format": "string", "minLength": 1, "optional": false, "maxLength": 255, "type": "string"}, "remote-file": {"optional": true, "type": "string", "description": "profile name for remote url", "format": "url"}, "use-mgmt-port": {"default": 0, "optional": true, "type": "number", "description": "Use management port as source port", "format": "flag"}, "period": {"description": "Specify the period in second", "format": "number", "type": "number", "maximum": 31536000, "minimum": 60, "optional": true}}}], "type": "array", "$ref": "/axapi/v3/export-periodic/ssl-cert-key/{ssl-cert-key}"}
    :param debug_monitor_list: {"minItems": 1, "items": {"type": "debug-monitor"}, "uniqueItems": true, "array": [{"required": ["debug-monitor"], "properties": {"remote-file": {"optional": true, "type": "string", "description": "profile name for remote url", "format": "url"}, "uuid": {"description": "uuid of the object", "format": "string", "minLength": 1, "modify-not-allowed": 1, "optional": true, "maxLength": 64, "type": "string"}, "debug-monitor": {"description": "Debug Monitor Output", "format": "string", "minLength": 1, "optional": false, "maxLength": 63, "type": "string"}, "use-mgmt-port": {"default": 0, "optional": true, "type": "number", "description": "Use management port as source port", "format": "flag"}, "period": {"description": "Specify the period in second", "format": "number", "type": "number", "maximum": 31536000, "minimum": 60, "optional": true}}}], "type": "array", "$ref": "/axapi/v3/export-periodic/debug-monitor/{debug-monitor}"}
    :param syslog_list: {"minItems": 1, "items": {"type": "syslog"}, "uniqueItems": true, "array": [{"required": ["syslog"], "properties": {"syslog": {"description": "Syslog file", "format": "string", "minLength": 1, "optional": false, "maxLength": 63, "type": "string"}, "uuid": {"description": "uuid of the object", "format": "string", "minLength": 1, "modify-not-allowed": 1, "optional": true, "maxLength": 64, "type": "string"}, "remote-file": {"optional": true, "type": "string", "description": "profile name for remote url", "format": "url"}, "use-mgmt-port": {"default": 0, "optional": true, "type": "number", "description": "Use management port as source port", "format": "flag"}, "period": {"description": "Specify the period in second", "format": "number", "type": "number", "maximum": 31536000, "minimum": 60, "optional": true}}}], "type": "array", "$ref": "/axapi/v3/export-periodic/syslog/{syslog}"}
