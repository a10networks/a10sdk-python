...
class Collector(A10BaseClass):
    ...
    :param ip_list: {"minItems": 1, "items": {"type": "ip"}, "uniqueItems": true, "array": [{"required": ["addr", "port"], "properties": {"uuid": {"description": "uuid of the object", "format": "string", "minLength": 1, "modify-not-allowed": 1, "optional": true, "maxLength": 64, "type": "string"}, "addr": {"optional": false, "type": "string", "description": "Configure sFlow collector IP address", "format": "ipv4-address"}, "port": {"description": "Port number (default is 6343)", "format": "number", "default": 6343, "optional": false, "maximum": 65535, "minimum": 1, "type": "number"}}}], "type": "array", "$ref": "/axapi/v3/sflow/collector/ip/{addr}+{port}"}
    :param ipv6_list: {"minItems": 1, "items": {"type": "ipv6"}, "uniqueItems": true, "array": [{"required": ["addr", "port"], "properties": {"uuid": {"description": "uuid of the object", "format": "string", "minLength": 1, "modify-not-allowed": 1, "optional": true, "maxLength": 64, "type": "string"}, "addr": {"optional": false, "type": "string", "description": "Configure sFlow collector IPv6 address", "format": "ipv6-address"}, "port": {"description": "Port number (default is 6343)", "format": "number", "default": 6343, "optional": false, "maximum": 65535, "minimum": 1, "type": "number"}}}], "type": "array", "$ref": "/axapi/v3/sflow/collector/ipv6/{addr}+{port}"}
