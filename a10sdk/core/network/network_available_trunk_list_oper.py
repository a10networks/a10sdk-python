...
class AvailableTrunkList(A10BaseClass):
    
    """Class Description::
    Operational Status for the object available-trunk-list.

    Class available-trunk-list supports CRUD Operations and inherits from `common/A10BaseClass`.
    ...
    URL for this object::
    `https://<Hostname|Ip address>//axapi/v3/network/available-trunk-list/oper`.
    ...
    def __init__(self, **kwargs):
        self.ERROR_MSG = ""
        self.required=[]
        self.b_key = "available-trunk-list"
        self.a10_url="/axapi/v3/network/available-trunk-list/oper"
        self.DeviceProxy = ""
        self.oper = {}
