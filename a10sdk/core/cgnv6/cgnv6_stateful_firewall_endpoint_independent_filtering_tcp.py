...
class Tcp(A10BaseClass):
    ...
    URL for this object::
    `https://<Hostname|Ip address>//axapi/v3/cgnv6/stateful-firewall/endpoint-independent-filtering/tcp`.
    ...
    def __init__(self, **kwargs):
        ...
        self.required=[]
        self.b_key = "tcp"
        self.a10_url="/axapi/v3/cgnv6/stateful-firewall/endpoint-independent-filtering/tcp"
        self.DeviceProxy = ""
        self.port_list = []
        self.uuid = ""
