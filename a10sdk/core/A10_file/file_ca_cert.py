...
class CaCert(A10BaseClass):
    ...
    :param file: {"description": "ssl ca certificate local file name", "format": "string", "minLength": 1, "optional": true, "maxLength": 255, "type": "string"}
    ...
    :param size: {"description": "ssl ca certificate file size in byte", "format": "number", "type": "number", "maximum": 2147483647, "minimum": 0, "optional": true}
    :param DeviceProxy: The device proxy for REST operations and session handling. Refer to `common/device_proxy.py`

Class Description::
    ssl certificate file information and management commands.

    Class ca-cert supports CRUD Operations and inherits from `common/A10BaseClass`.
    This class is the `"PARENT"` class for this module.`

    

    URL for this object::
    `https://<Hostname|Ip address>//axapi/v3/file/ca-cert`.
    ...
    def __init__(self, **kwargs):
        ...
        self.required=[]
        self.b_key = "ca-cert"
        self.a10_url="/axapi/v3/file/ca-cert"
        self.DeviceProxy = ""
        self.pfx_password = ""
        self.csr_generate = ""
        self.dst_file = ""
