...
class Lsn(A10BaseClass):
    ...
    """    :param health_check_gateway_list: {"minItems": 1, "items": {"type": "health-check-gateway"}, "uniqueItems": true, "array": [{"required": ["ipv4-addr", "ipv6-addr"], "properties": {"ipv4-addr": {"optional": false, "type": "string", "description": "Specify IPv4 Gateway", "format": "ipv4-address"}, "ipv6-addr": {"optional": false, "type": "string", "description": "Specify IPv6 Gateway", "format": "ipv6-address"}, "uuid": {"description": "uuid of the object", "format": "string", "minLength": 1, "modify-not-allowed": 1, "optional": true, "maxLength": 64, "type": "string"}}}], "type": "array", "$ref": "/axapi/v3/cgnv6/lsn/health-check-gateway/{ipv4-addr}+{ipv6-addr}"}
    :param port_reservation_list: {"minItems": 1, "items": {"type": "port-reservation"}, "uniqueItems": true, "array": [{"required": ["inside", "inside-port-start", "inside-port-end", "nat", "nat-port-start", "nat-port-end"], "properties": {"inside-port-start": {"description": "Inside Start Port", "format": "number", "type": "number", "maximum": 65535, "minimum": 1, "optional": false}, "uuid": {"description": "uuid of the object", "format": "string", "minLength": 1, "modify-not-allowed": 1, "optional": true, "maxLength": 64, "type": "string"}, "nat-port-start": {"description": "NAT Start Port", "format": "number", "type": "number", "maximum": 65535, "minimum": 1, "optional": false}, "inside-port-end": {"description": "Inside End Port", "format": "number", "type": "number", "maximum": 65535, "minimum": 1, "optional": false}, "inside": {"optional": false, "type": "string", "description": "Inside User Address and Port Range (Inside User IP address)", "format": "ipv4-address"}, "nat": {"optional": false, "type": "string", "description": "NAT IP address", "format": "ipv4-address"}, "nat-port-end": {"description": "NAT End Port", "format": "number", "type": "number", "maximum": 65535, "minimum": 1, "optional": false}}}], "type": "array", "$ref": "/axapi/v3/cgnv6/lsn/port-reservation/{inside}+{inside-port-start}+{inside-port-end}+{nat}+{nat-port-start}+{nat-port-end}"}
