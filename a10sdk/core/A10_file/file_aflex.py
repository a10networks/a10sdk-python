...
class Aflex(A10BaseClass):
    ...
    :param file: {"description": "aflex local file name", "format": "string", "minLength": 1, "optional": true, "maxLength": 63, "type": "string"}
    :param size: {"optional": true, "type": "number", "description": "aflex file size in byte", "format": "number"}
