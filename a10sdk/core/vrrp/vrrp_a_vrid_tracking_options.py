...
class Interface(A10BaseClass):
    ...
    :param ethernet: {"type": "number", "description": "Ethernet Interface. help-val Ethernet interface number", "format": "interface"}
    :param priority_cost: {"description": "The amount the priority will decrease. help-val Priority", "minimum": 1, "type": "number", "maximum": 255, "format": "number"}
...
class Ipv6DestinationCfg(A10BaseClass):
    ...
    :param priority_cost: {"description": "The amount the priority will decrease if the route is missing. help-val The amount the priority will decrease if the route is not present", "minimum": 1, "type": "number", "maximum": 255, "format": "number"}
...
class VlanCfg(A10BaseClass):
    ...
    :param vlan: {"description": "VLAN tracking. help-val VLAN id", "minimum": 2, "type": "number", "maximum": 4094, "format": "number"}
...
class TrunkCfg(A10BaseClass):
    ...
    :param per_port_pri: {"description": "per port priority. help-val Priority", "format": "number", "default": 1, "maximum": 255, "minimum": 1, "type": "number"}
    :param priority_cost: {"description": "The amount the priority will decrease. help-val Priority", "minimum": 1, "type": "number", "maximum": 255, "format": "number"}
    :param trunk: {"description": "trunk tracking. help-val Trunk Number", "minimum": 1, "type": "number", "maximum": 16, "format": "number"}
    :param DeviceProxy: The device proxy for REST operations and session handling. Refer to `common/device_proxy.py`
...
class TrackingOptions(A10BaseClass):
    ...
    :param interface: {"minItems": 1, "items": {"type": "object"}, "uniqueItems": true, "type": "array", "array": [{"properties": {"ethernet": {"type": "number", "description": "Ethernet Interface. help-val Ethernet interface number", "format": "interface"}, "optional": true, "priority-cost": {"description": "The amount the priority will decrease. help-val Priority", "minimum": 1, "type": "number", "maximum": 255, "format": "number"}}}]}
    :param vlan_cfg: {"minItems": 1, "items": {"type": "object"}, "uniqueItems": true, "type": "array", "array": [{"properties": {"vlan": {"description": "VLAN tracking. help-val VLAN id", "minimum": 2, "type": "number", "maximum": 4094, "format": "number"}, "optional": true, "timeout": {"minimum": 2, "type": "number", "maximum": 600, "format": "number"}, "priority-cost": {"description": "The amount the priority will decrease. help-val Priority", "minimum": 1, "type": "number", "maximum": 255, "format": "number"}}}]}
    :param trunk_cfg: {"minItems": 1, "items": {"type": "object"}, "uniqueItems": true, "type": "array", "array": [{"properties": {"per-port-pri": {"description": "per port priority. help-val Priority", "format": "number", "default": 1, "maximum": 255, "minimum": 1, "type": "number"}, "priority-cost": {"description": "The amount the priority will decrease. help-val Priority", "minimum": 1, "type": "number", "maximum": 255, "format": "number"}, "optional": true, "trunk": {"description": "trunk tracking. help-val Trunk Number", "minimum": 1, "type": "number", "maximum": 16, "format": "number"}}}]}
    :param DeviceProxy: The device proxy for REST operations and session handling. Refer to `common/device_proxy.py`

    

    URL for this object::
    `https://<Hostname|Ip address>//axapi/v3/vrrp-a/vrid/{vrid_val}/tracking-options`.
    ...
    def __init__(self, **kwargs):
        ...
        self.a10_url="/axapi/v3/vrrp-a/vrid/{vrid_val}/tracking-options"
        self.DeviceProxy = ""
        self.interface = []
        self.route = {}
        self.vlan_cfg = []
