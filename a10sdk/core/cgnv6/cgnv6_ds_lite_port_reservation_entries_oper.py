...
class EntryList(A10BaseClass):
    ...
    :param tunnel_dest_address: {"type": "string", "format": "ipv6-address"}
    :param inside_start_port: {"type": "number", "format": "number"}
    :param nat_address: {"type": "string", "format": "ipv4-address"}
    :param tunnel_src_address: {"type": "string", "format": "ipv6-address"}
...
class Oper(A10BaseClass):
    ...
    :param entry_list: {"minItems": 1, "items": {"type": "object"}, "uniqueItems": true, "type": "array", "array": [{"properties": {"nat-end-port": {"type": "number", "format": "number"}, "tunnel-dest-address": {"type": "string", "format": "ipv6-address"}, "inside-start-port": {"type": "number", "format": "number"}, "nat-address": {"type": "string", "format": "ipv4-address"}, "tunnel-src-address": {"type": "string", "format": "ipv6-address"}, "inside-end-port": {"type": "number", "format": "number"}, "nat-start-port": {"type": "number", "format": "number"}, "optional": true, "inside-address": {"type": "string", "format": "ipv4-address"}}}]}
    :param DeviceProxy: The device proxy for REST operations and session handling. Refer to `common/device_proxy.py`
...
class PortReservationEntries(A10BaseClass):
    ...
    URL for this object::
    `https://<Hostname|Ip address>//axapi/v3/cgnv6/ds-lite/port-reservation-entries/oper`.
    ...
    def __init__(self, **kwargs):
        ...
        self.a10_url="/axapi/v3/cgnv6/ds-lite/port-reservation-entries/oper"
        self.DeviceProxy = ""
        self.oper = {}
