...
class Aflex(A10BaseClass):
    ...
    :param aflex: {"description": "aFleX Script Source File", "format": "string-rlx", "minLength": 1, "optional": false, "maxLength": 63, "type": "string"}
    ...
    URL for this object::
    `https://<Hostname|Ip address>//axapi/v3/export-periodic/aflex/{aflex}`.
    ...
    def __init__(self, **kwargs):
        ...
        self.b_key = "aflex"
        self.a10_url="/axapi/v3/export-periodic/aflex/{aflex}"
        self.DeviceProxy = ""
        self.aflex = ""
        self.uuid = ""
        self.remote_file = ""
