...
class ClassList(A10BaseClass):
    ...
    :param name: {"description": "Class list name", "format": "string-rlx", "minLength": 1, "optional": false, "maxLength": 63, "type": "string"}
    ...
    URL for this object::
    `https://<Hostname|Ip address>//axapi/v3/cgnv6/template/policy/{name}/class-list`.
    ...
    def __init__(self, **kwargs):
        ...
        self.a10_url="/axapi/v3/cgnv6/template/policy/{name}/class-list"
        self.DeviceProxy = ""
        self.header_name = ""
        self.lid_list = []
        self.name = ""
