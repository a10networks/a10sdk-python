...
class CtrlCpu(A10BaseClass):
    
    """Class Description::
    Operational Status for the object ctrl-cpu.

    Class ctrl-cpu supports CRUD Operations and inherits from `common/A10BaseClass`.
    ...
    URL for this object::
    `https://<Hostname|Ip address>//axapi/v3/system-cpu/ctrl-cpu/oper`.
    ...
    def __init__(self, **kwargs):
        ...
        self.required=[]
        self.b_key = "ctrl-cpu"
        self.a10_url="/axapi/v3/system-cpu/ctrl-cpu/oper"
        self.DeviceProxy = ""
        self.oper = {}
