...
class Ospf(A10BaseClass):
    ...
    def __init__(self, **kwargs):
        ...
        self.required=[]
        self.b_key = "ospf"
        self.a10_url="/axapi/v3/interface/trunk/{ifnum}/ip/ospf"
        self.DeviceProxy = ""
        self.ospf_ip_list = []
        self.ospf_global = {}
