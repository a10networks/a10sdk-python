...
class ClassList(A10BaseClass):
    ...
    :param file: {"description": "class list local file name", "format": "string", "minLength": 1, "optional": true, "maxLength": 63, "type": "string"}
    :param size: {"description": "class list file size in byte", "format": "number", "type": "number", "maximum": 2147483647, "minimum": 0, "optional": true}
...
Class Description::
    ...
    URL for this object::
    `https://<Hostname|Ip address>//axapi/v3/file/class-list`.
    ...
    def __init__(self, **kwargs):
        ...
        self.a10_url="/axapi/v3/file/class-list"
        self.DeviceProxy = ""
        self.action = ""
        self.dst_file = ""
        self.file_handle = ""
