...
class DnsNsRecord(A10BaseClass):
    ...
    URL for this object::
    `https://<Hostname|Ip address>//axapi/v3/gslb/zone/{name}/service/{service_port}+{service_name}/dns-ns-record/{ns_name}/stats`.
    ...
    def __init__(self, **kwargs):
        ...
        self.a10_url="/axapi/v3/gslb/zone/{name}/service/{service_port}+{service_name}/dns-ns-record/{ns_name}/stats"
        self.DeviceProxy = ""
        self.stats = {}
        self.ns_name = ""
