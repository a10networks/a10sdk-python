...
class Oper(A10BaseClass):
    ...
    :param state: {"enum": ["All Up", "Functional Up", "Down", "Disb", "Unkn"], "type": "string", "format": "enum"}
...
class ServiceGroup(A10BaseClass):
    ...
    URL for this object::
    `https://<Hostname|Ip address>//axapi/v3/slb/service-group/{name}/oper`.
    ...
    def __init__(self, **kwargs):
        ...
        self.a10_url="/axapi/v3/slb/service-group/{name}/oper"
        self.DeviceProxy = ""
        self.oper = {}
        self.member_list = []
        self.name = ""
